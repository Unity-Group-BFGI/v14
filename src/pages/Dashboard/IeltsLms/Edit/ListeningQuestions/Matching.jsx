import { update_question_matching, } from '../../../../../includes/redux-store/Slices/ieltsLms.slice';
...
const QuestionMainMatchingListening = () => {
    const toolbar                                       = ``;
    ...
    const setHtml = (html) => {
        dispatch(update_question_matching({
            QUESTION:{
                ...IELTS_LMS_QUESTION_MATCHING_LISTENING.QUESTION,
                HTML: html
            }
        }));
    };
    ...
    const changeAnswerType = (event) => {
        ...
        if(IELTS_LMS_QUESTION_TYPE === "matching"){
            ...
            if (value === 'custom') {
                const num = IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS || 1; // Use the current number of options or default to 1
                const currentCustomOptions = IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom;
                ...
                dispatch(update_question_matching({
                    ANSWER_SETTINGS: {
                        ...IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS,
                        ANSWER_TYPE: 'custom', // Set the answer type to 'custom'
                        NUMBER_OF_OPTIONS: num,
                        ANSWER_TYPES: {
                            ...IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES,
    ...
    const changeNumberOfOptions = (event) => {
        ...
        if(IELTS_LMS_QUESTION_TYPE === "matching"){
            const currentCustomOptions = IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom;
            if (IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE === 'custom') {
                const newCustomOptions = [...currentCustomOptions];
                if (newCustomOptions.length < num) {
                    // Add blank strings to the custom array
                    const diff = num - newCustomOptions.length;
    ...
    const updateCustomOption = (index, newValue) => {
        if(IELTS_LMS_QUESTION_TYPE === "matching"){
            const newCustomOptions = [...IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom];
    ...
    useEffect(() => {
        setHtmlEditor(<LoadEditorLight toolbar={toolbar} html={IELTS_LMS_QUESTION_MATCHING_LISTENING.QUESTION.HTML} setHtml={setHtml} />);
    },[]);
            ...
            <div className="step__controller row">
                ...
                <div className="col-sm-6 col-xs-12 mb-4">
                    ...
                    <select 
                        ...
                        value={IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE}
                ...
                <div className="col-sm-6 col-xs-12 mb-4">
                    ...
                    <input 
                        ...
                        value={IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS}
                        onChange={changeNumberOfOptions}
                    />    
                </div> 

                { /* custom options */ }
                {IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS && IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE === "custom" && <div className="custom__options">
                    <label htmlFor="custom-options" className='mb-6'>List of Custom options</label>
                    {IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom && IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom.length > 0 && IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom.map((option,index) => {
            ...
            <div className="step__controller row">
                ...
                <div className="col-md-12 mb-6">
                    ...
                    {IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS && <>
                        ...
                        {IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES[IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE].slice(0, +IELTS_LMS_QUESTION_MATCHING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS).map((option, index) => {
...
export { QuestionMainMatchingListening };
