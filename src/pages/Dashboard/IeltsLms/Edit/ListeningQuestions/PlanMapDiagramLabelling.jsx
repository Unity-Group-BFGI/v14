...
import { update_question_plan_map_diagram_labelling_listening } from '../../../../../includes/redux-store/Slices/ieltsLms.slice';
...
const QuestionMainPlanMapDiagramLabelling = () => {
    ...
    const setHtml = (html) => {
        dispatch(update_question_plan_map_diagram_labelling_listening({
            QUESTION:{
                ...IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.QUESTION,
                HTML: html
            }
        }));
    };
    ...
    const changeAnswerType = (event) => {
        ...
        if(IELTS_LMS_QUESTION_TYPE === "plan-map-diagram-labelling"){
            // Check if the new answer type is 'custom'
            if (value === 'custom') {
                const num = IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS || 1; // Use the current number of options or default to 1
                const currentCustomOptions = IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom;
                ...
                dispatch(update_question_plan_map_diagram_labelling_listening({
                    ANSWER_SETTINGS: {
                        ...IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS,
                        ANSWER_TYPE: 'custom', // Set the answer type to 'custom'
                        NUMBER_OF_OPTIONS: num,
                        ANSWER_TYPES: {
                            ...IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES,
    ...
    const changeNumberOfOptions = (event) => {
        ...
        if(IELTS_LMS_QUESTION_TYPE === "plan-map-diagram-labelling"){
            const currentCustomOptions = IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom;
            if (IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE === 'custom') {
                const newCustomOptions = [...currentCustomOptions];
                if (newCustomOptions.length < num) {
                    // Add blank strings to the custom array
                    const diff = num - newCustomOptions.length;
    ...
    const updateCustomOption = (index, newValue) => {
        if(IELTS_LMS_QUESTION_TYPE === "plan-map-diagram-labelling"){
            const newCustomOptions = [...IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom];
    ...
    useEffect(() => {
        setHtmlEditor(<LoadEditorLight toolbar={toolbar} html={IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.QUESTION.HTML} setHtml={setHtml} />);
    },[]);

    return (<>
        {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.QUESTION_SETTINGS.QUESTION_LAYOUT === "select" && <>
                ...
                <div className="step__controller row">
                    ...
                    <div className="col-sm-6 col-xs-12 mb-4">
                        ...
                        <select 
                            ...
                            value={IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE}
                    ...
                    <div className="col-sm-6 col-xs-12 mb-4">
                        ...
                        <input 
                            ...
                            value={IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS}
                            onChange={changeNumberOfOptions}
                        />    
                    </div> 

                    { /* custom options */ }
                    {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS && IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE === "custom" && <div className="custom__options">
                        <label htmlFor="custom-options" className='mb-6'>List of Custom options</label>
                        {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom && IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom.length > 0 && IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES.custom.map((option,index) => {
                ...
                <div className="step__controller row">
                    ...
                    <div className="col-md-12 mb-6">
                        ...
                        {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS && <>
                            ...
                            {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPES[IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.ANSWER_TYPE].slice(0, +IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS).map((option, index) => {
        ...
        {IELTS_LMS_QUESTION_PLAN_MAP_DIAGRAM_LABELLING_LISTENING.QUESTION_SETTINGS.QUESTION_LAYOUT === "fillup" && <>
            <div className="step-1 steps tab-step__padding mb-10">
                <div className="step__controller row">
                    <div className="col-md-12 mb-6">
                        <label htmlFor="question-html" className='required'>Question (html)</label>
