...
const QuestionMainSummaryFormCompletion = () => {
    ...
    const setHtml = (html) => {
        dispatch(update_question_summary_form_completion({
            QUESTION:{
                ...IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTION,
                HTML: html
            }
        }));
    };
    ...
    const handleCorrectAnswerChangeRadio = (qindex,oindex) => {
        dispatch(update_question_summary_form_completion_question_option({
            oindex: oindex,
            qindex: qindex
        }));
    };
    ...
    const addQuestionOption = (qindex) => {
        dispatch(update_question_summary_form_completion_question_add_option({
            qindex: qindex,
            option: {
                HTML: '',
                CORRECT: false
    ...
    const updateOptionContent = (qindex,oindex, html) => {
        dispatch(update_question_summary_form_completion_question_update_option({
            qindex: qindex,
            oindex: oindex,
            html: html
        }));
    ...
    const updateQuestionsContent = (qindex, html) => {
        dispatch(update_question_summary_form_completion_update_questions_content({
            qindex: qindex,
            html: html
        }));
    };
    ...
    const removeQuestionOption = (qindex,oindex) => {
        dispatch(update_question_summary_form_completion_remove_questions_option({
            qindex: qindex,
            oindex: oindex
        }));
    };
    ...
    useEffect(() => {
        setHtmlEditor(<LoadEditorLight toolbar={toolbar} html={IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTION.HTML} setHtml={setHtml} />);
    },[]);

    return (<>
        {IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTION_SETTINGS.QUESTION_LAYOUT === "fillup" && <>
        ...
        {IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTION_SETTINGS.QUESTION_LAYOUT === "radio" && <>
            ...
            <div className="step-1 steps tab-step__padding mb-10">
                <div className="step__controller row">
                        ...
                        <div className="col-md-12 mb-6">
                            ...
                            {IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTIONS && IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTIONS.length > 0 && IELTS_LMS_QUESTION_SUMMARY_FORM_COMPLETION_READING.QUESTIONS.map((qus,index) => {
