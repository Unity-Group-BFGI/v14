import { update_question_true_false_notgiven} from '../../../../../includes/redux-store/Slices/ieltsLms.slice';
...
const QuestionMainTrueFalseNotgiven = () => {
    ...
    useEffect(() => {
        setHtmlEditor(<LoadEditorLight toolbar={toolbar} html={IELTS_LMS_QUESTION_TRUE_FALSE_NOTGIVEN_READING.QUESTION.HTML} setHtml={setHtml} />);
    },[]);
        ...
        <div className="step-1 steps tab-step__padding mb-10">
            <div className="step__controller row">
                <div className="col-md-12 mb-6">
                    ...
                    {IELTS_LMS_QUESTION_TRUE_FALSE_NOTGIVEN_READING.ANSWER_SETTINGS && <>
                        <ul className='question__options-ul mb-2'>
                        {IELTS_LMS_QUESTION_TRUE_FALSE_NOTGIVEN_READING.ANSWER_SETTINGS.ANSWER_TYPES[IELTS_LMS_QUESTION_TRUE_FALSE_NOTGIVEN_READING.ANSWER_SETTINGS.ANSWER_TYPE].slice(0, +IELTS_LMS_QUESTION_TRUE_FALSE_NOTGIVEN_READING.ANSWER_SETTINGS.NUMBER_OF_OPTIONS).map((option, index) => {
...
export { QuestionMainTrueFalseNotgiven };