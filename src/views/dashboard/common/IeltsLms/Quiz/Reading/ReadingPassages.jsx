...
const IeltsLmsEditQuizReadingPassages = () => {
    const HEADING = 'List of Reading Passages';
    ...
    const getQuestions = (sid)  => {
        ...
        dispatch(update_menu({
            CURRENT_DYNAMIC_PARAM: 'IELTS-LMS-EDIT-QUIZ-READING-QUESTIONS'
        }));
    };
...
const SectionItem = ({ section, index, handleRefresh, getQuestions, showEditSectionModal , length }) => {
    const POST_TYPE                                     = 'reading-passage';
    const QUIZ_CATEGORY                                 = 'reading';
    const { id }                                        = useParams();
    const { ENDPOINT }                                  = ENDPOINTS;
...
const AddEditSectionModal = ({ reload, showSectionModal, handleCloseAddEditSection, handleRefresh, type, sid, cancelTokenSource }) => {
    ...
    useEffect(() => {
        if( type === "new" ) {
            ...
            setModalTitle('Add Reading Passage');
            ...
            setModalTitle('Edit Reading Passage');
...
export default IeltsLmsEditQuizReadingPassages;