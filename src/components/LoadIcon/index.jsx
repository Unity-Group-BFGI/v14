    ...
    useEffect(() => {
        switch(icon){
            ...
            case ("icon-my-domains-add-new"):
                setIcon(<i className="ki-duotone ki-element-plus fx-1">
                    <span className="path1"></span>
                    <span className="path2"></span>
                    <span className="path3"></span>
                    <span className="path4"></span>
            ...
            case ("icon-ielts-lms-free-quizzes"):
                ...
                break;
            case ("icon-ielts-lms-my-courses"): 
                setIcon(<i className="ki-duotone ki-teacher">
                    <span className="path1"></span>
                    <span className="path2"></span>
                </i>);
                break;
            case ("icon-market"): 
                setIcon(<i className="ki-duotone ki-briefcase fs-2x">
                    <span className="path1"></span>
                    <span className="path2"></span>
                </i>);
                break;
