...
const IeltsLmsEditQuizDynamicMenuSkeleton = () => {
    return (<>
        ...
        <div className={"menu-link d-flex flex-row align-items-stretch mb-1 mt-4"} style={{ border: "1px", padding: "5px 10px 5px 5px" }}>
            <Placeholder animation="glow" as="p" xs={2} className={"mr-4 d-flex custom-p"}>
...
const IeltsLmsEditQuizSectionsListSkeleton = () => {
                            ...
                            return (<React.Fragment key={index}>
                                <div className="d-flex flex-stack">
                                    <div className="d-flex">
                                        <img className="w-40px h-40px me-6" />
                                        <div className="d-flex flex-column">
...
const IeltsLmsEditQuizSectionSkeleton = () => {
    return (<>
...
const IeltsLmsEditQuizQuestionSkeleton = () => {
    return (<>
        <form className="" style={{ display: 'contents' }}>
            <div className="modal-body">
                    ...
                    <div className="py-2">
                        ...
                        {(loaders && loaders.length > 0 && loaders.map((loader, index) => {
                            return (<React.Fragment key={index}>
                                <div className="d-flex flex-stack">
                                    <div className="d-flex">
                                        <Placeholder animation="glow" as="div" className="w-40px h-40px me-6">
                                            <Placeholder style={{ width: "40px", height: '40px' }} xs={4} />
                                        </Placeholder>
                                        <div className="d-flex flex-column">
...
const QuizForMyDomainsSingleSkeleton = () => {
    return (<>
        <div className="d-flex flex-stack">
            <div className="d-flex">
                <Placeholder animation="glow" as="div" className="w-40px h-40px me-6">
...
export {
    ...
    IeltsLmsEditQuizSectionsListSkeleton,
    IeltsLmsEditQuizOverviewSkeleton,
    IeltsLmsEditQuizSectionSkeleton,
    IeltsLmsEditQuizQuestionSkeleton,
